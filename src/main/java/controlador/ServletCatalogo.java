    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException
    {
     	...
     	ArrayList<String> respuestas =  ControladorWeb.solicitarDatosCategoria(categoria);
       	String contenido = "";
       	 ...
       	 else if(tipoDocumento.equals("TXT"))
       	 {	
       		int cont = 1;
       		 for(int i =0; i<respuestas.size(); i=i+2){
       			 contenido += " "+cont++ + " -Pregunta: "+respuestas.get(i+1) + " \n\r\n\r "+" respuesta: "+respuestas.get(i) +" \n\r\n\r "+" \n\r\n\r "  ;
       		 }
    		...
    		response.setHeader("Content-Disposition","attachment;filename=Documento_Watson_Tutor.txt");
